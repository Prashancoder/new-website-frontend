...
const courses = [
  {
    ...
    description: "Comprehensive fellowship across permanent makeup and cosmetology.",
  ...
  },
  {
    ...
    description: "Integrated program spanning injectables and cosmetology.",
    image: "/images/courses/1.webp",
  },
  {
    title: "Fellowship in Facial Aesthetics",
    link: "/courses/fellowship/facial-aesthetics",
    description: "Focused fellowship on facial aesthetic treatments and protocols.",
    image: "/images/courses/2.webp",
  },
  {
    title:
      "Fellowship in Permanent Make up & Cosmetology, Medical Micropigmentation , Plasma Pen",
    link: "/courses/fellowship/permanent-micropigmentation",
    description:
      "Advanced fellowship with medical micropigmentation and plasma pen.",
    image: "/images/courses/3.webp",
  },
  {
    title:
      "Fellowship in Facial Aesthetics, Permanent Make up & Cosmetology, Medical Micropigmentation , Plasma Pen",
    link: "/courses/fellowship/facial-permanent-micropigmentation",
    description:
      "Comprehensive cross-discipline fellowship with clinical immersion.",
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-[#555555] font-lato leading-relaxed mb-6">
              Advanced clinical training with mentored, hands-on exposure to real
              cases across dentistry specialties.
            </p>
            <Link
              to="/contact"
